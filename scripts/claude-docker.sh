...
DOCKER_LABEL="braintrust-go-sdk"
...
if [ -d "/workspace/repo" ]; then
    ...
    if [ -f "mise.toml" ]; then
        ...
        echo "Installing Go and tools via mise..."
        mise trust
        mise install
...
cmd_create() {
    ...
    local CONTAINER_NAME="sdk-go-$(echo "$FEATURE_BRANCH" | sed 's|/|-|g')"
