...
require (
	github.com/braintrustdata/braintrust-sdk-go/trace/contrib/adk v0.10.0
	...
	github.com/braintrustdata/braintrust-sdk-go/trace/contrib/langchaingo v0.10.0
...
require (
	...
	github.com/braintrustdata/braintrust-sdk-go v0.10.0 // indirect
