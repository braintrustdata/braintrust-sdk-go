...
require (
	github.com/braintrustdata/braintrust-sdk-go/trace/contrib/adk v0.9.1
	...
	github.com/braintrustdata/braintrust-sdk-go/trace/contrib/langchaingo v0.9.1
...
require (
	...
	github.com/braintrustdata/braintrust-sdk-go v0.9.1 // indirect
