...
//
// Braintrust modification (see VENDOR.md): partial tags are rejected at parse
// time, so no provider is ever consulted. This type remains only because the
// PartialProvider plumbing does.
