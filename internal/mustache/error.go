...
const (
	...
	// ErrPartialNotSupported is a braintrust addition (see VENDOR.md): partials
	// are rejected rather than resolved.
	ErrPartialNotSupported ErrorCode = "partial_not_supported"
)
...
func (e ParseError) defaultMessage() string {
	...
	case ErrPartialNotSupported:
		return fmt.Sprintf("partial %q is not supported", e.Reason)
	default:
