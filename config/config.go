...
type Config struct {
	...
	FilterAISpans        bool
	AllowNativeAdkTraces bool // if false (default), drop Google ADK native spans to avoid duplicates
...
func FromEnv() *Config {
	return &Config{
		...
		AllowNativeAdkTraces: getEnvBool("BRAINTRUST_OTEL_ALLOW_NATIVE_ADK_TRACES", false),
	}
}
